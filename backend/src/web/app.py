...
_protected_router.include_router(call_router)
_protected_router.include_router(calls_router)
_protected_router.include_router(exercise_router)
_protected_router.include_router(exercises_router)
_protected_router.include_router(member_router)
_protected_router.include_router(members_router)
_protected_router.include_router(qualification_router)
_protected_router.include_router(qualifications_router)
_protected_router.include_router(subject_router)
_protected_router.include_router(subjects_router)
_protected_router.include_router(youth_exercise_router)
_protected_router.include_router(youth_exercises_router)
_protected_router.include_router(member_extra_router)
_protected_router.include_router(statistics_router)

_api_router.include_router(_protected_router)
